                ...
                {props.movies.map((movie) => ( // Bu örnekteki arrow function, JSX içinde kullanılıyor ve birçok JSX elementi döndürüyor. Bir arrow function'un bir JSX elementi döndürmesi için, JSX'in parantez içinde olması gerekiyor. 
                    ...
                    <div className='col-lg-3' key={movie.id}>
                        <div className='card mt-3'>
                            <img src={`https://www.themoviedb.org/t/p/w220_and_h330_face/${movie.poster_path}` } className='card-img-top' alt='Sample Movie' height="400" />
                            <div className='card-body'>
                                ...
                                <div className='d-flex justify-content-between align-items-center'>
                                    ...
                                    <h2><span className='badge bg-info'>{movie.vote_average}</span></h2> {/* Event handler, bir programlama dilinde bir olay (event) gerçekleştiğinde çalıştırılacak olan kod bloğu veya işlevdir. */}
                                </div>
                            </div>
                        </div>
                    </div>
